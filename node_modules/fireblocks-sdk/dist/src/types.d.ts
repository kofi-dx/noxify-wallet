...
export type APIResponseHeaders = AxiosResponseHeaders & {
    "x-request-id"?: string;
};
...
export declare enum TravelRuleAddressTypeCode {
    HOME = "HOME",
    BIZZ = "BIZZ",
    GEOG = "GEOG"
}
...
export declare enum ScreeningSupportedProviders {
...
declare enum NFTSpamSourceEnum {
    OWNER = "OWNER",
    SYSTEM = "SYSTEM"
}
...
export declare enum GetNFTsSortValues {
...
export declare enum GetOwnedCollectionsSortValues {
    "name" = "name"
}
export declare enum GetOwnedAssetsSortValues {
    "name" = "name"
}
...
export declare enum NFTOwnershipStatus {
    "LISTED" = "LISTED",
    "ARCHIVED" = "ARCHIVED"
}
...
export declare enum NFTOwnershipWalletType {
    "VAULT_ACCOUNT" = "VAULT_ACCOUNT",
    "END_USER_WALLET" = "END_USER_WALLET"
}
...
export declare enum NFTSpamTokenOwnership {
    "true" = "true",
    "false" = "false",
    "all" = "all"
}
...
export declare class BatchTask {
    id: string;
    jobId: string;
    type: string;
    tenantId: string;
...
export declare enum SmartTransfersTicketDirection {
    EXCHANGE = "EXCHANGE",
    SEND = "SEND",
    RECEIVE = "RECEIVE",
    INTERMEDIATE = "INTERMEDIATE"
}
export declare enum SmartTransfersTicketStatus {
    DRAFT = "DRAFT",
...
export declare enum SmartTransferTicketTermStatus {
    CREATED = "CREATED",
    FUNDING = "FUNDING",
...
export declare namespace NCW {
    const WalletIdHeader = "X-End-User-Wallet-Id";
    ...
    interface GetWalletsPayload {
        pageCursor?: string;
        pageSize?: number;
        sort?: string;
        order?: "ASC" | "DESC";
    }
    interface GetSupportedAssetsPayload {
        pageCursor?: string;
        pageSize?: number;
        onlyBaseAssets?: boolean;
    }
    interface GetWalletAccountsPayload {
        pageCursor?: string;
        pageSize?: number;
        sort?: string;
        order?: "ASC" | "DESC";
    }
    interface GetWalletAssetsPayload {
        pageCursor?: string;
        pageSize?: number;
        sort?: string;
        order?: "ASC" | "DESC";
    }
    interface GetWalletAddressesPayload {
        pageCursor?: string;
        pageSize?: number;
        sort?: string;
        order?: "ASC" | "DESC";
...
export declare namespace TAP {
    type PolicyTransactionType = "*" | "CONTRACT_CALL" | "RAW" | "TRANSFER" | "APPROVE" | "MINT" | "BURN" | "SUPPLY" | "REDEEM" | "STAKE" | "TYPED_MESSAGE";
    type PolicySrcOrDestType = "EXCHANGE" | "UNMANAGED" | "VAULT" | "NETWORK_CONNECTION" | "COMPOUND" | "FIAT_ACCOUNT" | "ONE_TIME_ADDRESS" | "*";
    ...
    type PolicyBaseErrorField = "operator" | "operators" | "authorizationGroups" | "designatedSigner" | "designatedSigners" | "contractMethods" | "amountAggregation" | "src" | "dst" | "";
