    ...
    subscriptions: {
        getAddress: (network) => {
            switch (network) {
                ...
                case service_1.Network.ETHEREUM_HOODI:
                ...
                case service_1.Network.BERACHAIN_MAINNET:
                case service_1.Network.MONAD_TESTNET:
                case service_1.Network.UNICHAIN_MAINNET:
                case service_1.Network.UNICHAIN_SEPOLIA:
