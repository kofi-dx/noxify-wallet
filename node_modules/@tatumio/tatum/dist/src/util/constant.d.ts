...
export declare const Constant: {
    ...
    DECIMALS: {
        ...
        "ronin-mainnet": number;
        "ronin-saigon": number;
        "kaia-mainnet": number;
        "kaia-kairos": number;
        "sonic-mainnet": number;
        "sonic-blaze": number;
        "berachain-mainnet": number;
        "unichain-mainnet": number;
        "unichain-sepolia": number;
        "monad-testnet": number;
    };
    CURRENCY_NAMES: {
        "bitcoin-mainnet": string;
        "bitcoin-testnet": string;
        "bitcoin-testnet4": string;
        "near-mainnet": string;
        "near-testnet": string;
        "egld-mainnet": string;
        "egld-testnet": string;
