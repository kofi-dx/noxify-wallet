...
exports.Constant = {
    ...
    DECIMALS: {
        ...
        [dto_1.Network.BITCOIN_TESTNET_4]: 8,
        ...
        [dto_1.Network.ETHEREUM_HOODI]: 18,
        [dto_1.Network.POLYGON]: 18,
        [dto_1.Network.POLYGON_AMOY]: 18,
        ...
        [dto_1.Network.KADENA]: 18,
        [dto_1.Network.KADENA_TESTNET]: 18,
        [dto_1.Network.COSMOS_ROSETTA]: 18,
        [dto_1.Network.IOTA]: 18,
        [dto_1.Network.IOTA_TESTNET]: 18,
        [dto_1.Network.BITCOIN_ELECTRS]: 18,
        [dto_1.Network.BITCOIN_ELECTRS_TESTNET]: 18,
        [dto_1.Network.ROSTRUM_TESTNET]: 18,
        [dto_1.Network.CASPER]: 18,
        [dto_1.Network.TON]: 9,
        [dto_1.Network.TON_TESTNET]: 9,
        [dto_1.Network.ZK_SYNC]: 18,
        [dto_1.Network.ZK_SYNC_TESTNET]: 18,
        [dto_1.Network.RONIN]: 18,
        [dto_1.Network.RONIN_SAIGON]: 18,
        [dto_1.Network.KAIA_MAINNET]: 18,
        [dto_1.Network.KAIA_KAIROS]: 18,
        [dto_1.Network.SONIC_MAINNET]: 18,
        [dto_1.Network.SONIC_BLAZE]: 18,
        [dto_1.Network.BERACHAIN_MAINNET]: 18,
        [dto_1.Network.UNICHAIN_MAINNET]: 18,
        [dto_1.Network.UNICHAIN_SEPOLIA]: 18,
        [dto_1.Network.MONAD_TESTNET]: 18,
    },
    CURRENCY_NAMES: {
        [dto_1.Network.BITCOIN]: 'BTC',
        [dto_1.Network.BITCOIN_TESTNET]: 'BTC',
        [dto_1.Network.BITCOIN_TESTNET_4]: 'BTC',
        ...
        [dto_1.Network.ETHEREUM_HOODI]: 'ETH',
        [dto_1.Network.POLYGON]: 'MATIC',
        [dto_1.Network.POLYGON_AMOY]: 'MATIC',
        ...
        [dto_1.Network.KADENA]: 'KADENA',
        [dto_1.Network.KADENA_TESTNET]: 'KADENA',
        [dto_1.Network.ROSTRUM]: 'BCH',
        [dto_1.Network.COSMOS_ROSETTA]: 'ATOM',
        [dto_1.Network.IOTA]: 'IOTA',
        [dto_1.Network.IOTA_TESTNET]: 'IOTA',
        [dto_1.Network.BITCOIN_ELECTRS]: 'BTC',
        [dto_1.Network.BITCOIN_ELECTRS_TESTNET]: 'BTC',
        [dto_1.Network.ROSTRUM_TESTNET]: 'BCH',
        [dto_1.Network.CASPER]: 'CASPER',
        [dto_1.Network.TON]: 'TON',
        [dto_1.Network.TON_TESTNET]: 'TON',
        [dto_1.Network.ZK_SYNC]: 'ZKS',
        [dto_1.Network.ZK_SYNC_TESTNET]: 'ZKS',
        [dto_1.Network.RONIN]: 'RON',
        [dto_1.Network.RONIN_SAIGON]: 'RON',
        [dto_1.Network.KAIA_MAINNET]: 'KAIA',
        [dto_1.Network.KAIA_KAIROS]: 'KAIA',
        [dto_1.Network.SONIC_MAINNET]: 'SONIC',
        [dto_1.Network.SONIC_BLAZE]: 'SONIC',
        [dto_1.Network.BERACHAIN_MAINNET]: 'BERA',
        [dto_1.Network.UNICHAIN_MAINNET]: 'UNI',
        [dto_1.Network.UNICHAIN_SEPOLIA]: 'UNI',
        [dto_1.Network.MONAD_TESTNET]: 'MON',
    },
    RPC: {
        MAINNETS: [
