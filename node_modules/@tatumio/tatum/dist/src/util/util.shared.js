...
exports.Utils = {
    ...
    mapNotificationChainToNetwork: (chain) => {
        switch (chain) {
            ...
            case dto_1.AddressEventNotificationChain.CRO:
                return dto_1.Network.CRONOS;
            ...
            case dto_1.AddressEventNotificationChain.FTM:
                return dto_1.Network.FANTOM;
            case dto_1.AddressEventNotificationChain.OP:
                return dto_1.Network.OPTIMISM;
            case dto_1.AddressEventNotificationChain.ARB:
                return dto_1.Network.ARBITRUM_ONE;
            case dto_1.AddressEventNotificationChain.BERA:
                return dto_1.Network.BERACHAIN_MAINNET;
            case dto_1.AddressEventNotificationChain.MON:
                return dto_1.Network.MONAD_TESTNET;
            case dto_1.AddressEventNotificationChain.UNI:
                return dto_1.Network.UNICHAIN_MAINNET;
            default:
    ...
    mapNetworkToNotificationChain: (network) => {
        switch (network) {
            ...
            case dto_1.Network.BITCOIN_TESTNET_4:
            ...
            case dto_1.Network.ETHEREUM_HOODI:
            ...
            case dto_1.Network.OPTIMISM_TESTNET:
                return dto_1.AddressEventNotificationChain.OP;
            case dto_1.Network.ARBITRUM_ONE:
                return dto_1.AddressEventNotificationChain.ARB;
            case dto_1.Network.BERACHAIN_MAINNET:
                return dto_1.AddressEventNotificationChain.BERA;
            case dto_1.Network.MONAD_TESTNET:
                return dto_1.AddressEventNotificationChain.MON;
            case dto_1.Network.UNICHAIN_MAINNET:
                return dto_1.AddressEventNotificationChain.UNI;
            default:
                throw new Error(`Network ${network} is not supported.`);
        }
    },
    ...
    getClient: (id, network) => {
        switch (network) {
            ...
            case dto_1.Network.RONIN:
            case dto_1.Network.RONIN_SAIGON:
                return new service_1.Ronin(id);
            case dto_1.Network.SONIC_BLAZE:
            case dto_1.Network.SONIC_MAINNET:
                return new service_1.Sonic(id);
            case dto_1.Network.KAIA_MAINNET:
            case dto_1.Network.KAIA_KAIROS:
                return new service_1.Kaia(id);
            case dto_1.Network.BERACHAIN_MAINNET:
                return new service_1.Berachain(id);
            case dto_1.Network.UNICHAIN_MAINNET:
            case dto_1.Network.UNICHAIN_SEPOLIA:
                return new service_1.Unichain(id);
            case dto_1.Network.MONAD_TESTNET:
                return new service_1.Monad(id);
